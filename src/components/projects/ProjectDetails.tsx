    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="mb-8">
          ...
          {project.progress?.currentPhase && (
            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
              Current phase:{' '}
              <span className="font-medium">{project.progress.currentPhase.replace('_', ' ')}</span>
            </p>
          )}
        </div>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                {project.episodeCount || 0} episodes
              </dd>
            </div>
          ...
          {project.projectSettings && (
            <div className="space-y-4">
              ...
              <div>
                ...
                <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                  {project.projectSettings.aspectRatio || '16:9'}
                </dd>
              </div>
              ...
              <div>
                ...
                <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100">
                  {project.projectSettings.episodeDuration || 22} minutes
                </dd>
              </div>
              ...
              <div>
                ...
                <dd className="mt-1 text-sm text-gray-900 dark:text-gray-100 capitalize">
                  {project.projectSettings.qualityTier || 'standard'}
                </dd>
              </div>
            </div>
          )}
        ...
        {project.progress?.completedSteps &&
          Array.isArray(project.progress.completedSteps) &&
          project.progress.completedSteps.length > 0 && (
            <div>
              <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-4">
                Completed Steps
              </h3>
              <div className="space-y-2">
                {(project.progress.completedSteps as string[]).map((step, index) => (
                  <div
                    key={index}
                    className="flex items-center space-x-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-md"
                  >
                    <svg
                    ...
                    <div className="flex-1">
                      ...
                      {(step as any).completedAt && (
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                          {formatDistanceToNow(new Date((step as any).completedAt), {
                            addSuffix: true,
                          })}
                        </p>
                      )}
