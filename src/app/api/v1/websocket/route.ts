...
function handleWebSocketMessage(connectionId: string, message: any) {
  ...
  switch (type) {
    ...
    case 'leave_session':
      ...
      const { sessionId: _leaveSessionId } = data
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { type, sessionId, projectId, message, excludeUserId: _excludeUserId } = data
...
// Utility functions for external use (not exported from API route)
// These would typically be in a separate service file
// export {
//   broadcastToSession,
//   broadcastToProject,
//   connections
